...
export function RoutePlanner({
  ...
  return (
    <div className="absolute top-4 left-4 sm:top-6 sm:left-6 z-[1000] w-[calc(100vw-2rem)] sm:w-80 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col transition-all">
      <div 
        className="bg-blue-600 p-4 text-white flex items-center justify-between cursor-pointer"
