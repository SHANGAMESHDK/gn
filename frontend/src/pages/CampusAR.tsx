  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-black text-white">
      ...
      {needsPermission && !permissionGranted && (
        <div className="absolute inset-0 z-[100] bg-slate-950/90 backdrop-blur-md flex flex-col items-center justify-center p-6 text-center">
          ...
          <p className="text-slate-400 mb-8 max-w-sm">To overlay points of interest correctly, we need access to your device's orientation sensors.</p>
          <button 
