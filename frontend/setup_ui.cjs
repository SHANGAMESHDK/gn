...
const sidebarContent = `import { Link } from 'react-router-dom';
...
fs.writeFileSync('src/components/common/Sidebar.tsx', sidebarContent);
fs.writeFileSync('src/components/common/Navbar.tsx', navbarContent);
